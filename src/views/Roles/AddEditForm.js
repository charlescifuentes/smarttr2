...
class AddEditForm extends Component {
  ...
  submitFormAdd = e => {
    ...
    axios.post('http://colombiaweb.co/smarttr/apirest/public/api/v1/roles', item)
    .then(res => {
  ...
  submitFormEdit = e => {
    ...
    axios.put(`http://colombiaweb.co/smarttr/apirest/public/api/v1/roles/${this.state.rol_id}`, item )
      .then(res => {
